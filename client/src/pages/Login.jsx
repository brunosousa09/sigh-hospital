...
import { User, Lock, Hospital, Radio, Loader2, CheckCircle2, Eye, EyeOff, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 px-4 sm:px-0">
      ...
      <div className="glass-card w-full max-w-[400px] p-8 sm:p-10 rounded-3xl relative z-10 animate-fade-up border border-white/10 shadow-2xl backdrop-blur-md bg-white/5">
        ...
        {errorMsg && (
          <div className="mb-4 p-3 bg-red-500/20 border border-red-500/50 rounded-lg flex items-center gap-2 text-red-200 text-sm animate-fade-up">
        ...
        <form onSubmit={handleLogin} className="space-y-6" autoComplete="off">
          ...
          <div className="relative group">
            <input 
              ...
              className="peer w-full bg-slate-950/30 border border-slate-700/50 rounded-xl px-4 pt-6 pb-2 pl-4 pr-12 text-white outline-none focus:border-cyan-400 focus:bg-slate-900/50 transition-all placeholder-transparent"
              placeholder=" " 
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 hover:text-cyan-400 transition-colors cursor-pointer z-20"
            >
      ...
      {booting && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-sm animate-fade-in px-4">
